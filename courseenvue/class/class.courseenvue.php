...
// gestion de la table courseenvue(id, date, nom, description)
// la colonne description est optionnelle

class CourseEnVue extends Table
{
    public function __construct()
    {
        // appel du contructeur de la classe parent
        parent::__construct('courseenvue');
    ...
    public static function getLesCourses(): array {
        $sql = <<<EOD
            select id, nom, date_format(date, '%d/%m/%Y') as dateFr, saison, description, distance, nbParticipant, lien 
            from courseenvue
            Order by date desc;
EOD;
